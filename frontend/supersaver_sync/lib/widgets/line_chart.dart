...
class FlLineChart extends StatefulWidget {
  const FlLineChart({super.key, required this.chart_type});
  ...
  LineChartData mainData() {
    return LineChartData(
      ...
      lineBarsData: [
        LineChartBarData(
          spots: [
            FlSpot(0, (widget.chart_type == 'Income') ? 3 : 2),
            FlSpot(2.6, 2),
            FlSpot(4.9, (widget.chart_type == 'Income') ? 5 : 4),
            FlSpot(6.8, 3.1),
            FlSpot(8, 4),
            FlSpot(9.5, 3),
            FlSpot(11, (widget.chart_type == 'Income') ? 5.7 : 3),
          ],
          isCurved: true,
